...
exports.validateWatch = ({
    ...
    if (!brand.match(/^([A-Z]{1}[a-z]*[ |-]{0,1})([A-Z]{1}[a-z]*)*$/gm)) {
        throw 'Марката е задължителна и може да се състои от няколко думи започващи с главна буква и разделени с интервал или "-"!';
    }
    if (model == '') {
